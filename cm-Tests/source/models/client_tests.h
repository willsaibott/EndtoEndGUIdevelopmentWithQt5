...
private:
  ...
  QByteArray jsonByteArray = R"(
  {
    ...
    "appointments": [
     {"start_at": "2017-08-20T12:45:00", "end_at": "2017-08-20T13:00:00", "notes": "Test appointment 1"},
     {"start_at": "2017-08-21T10:30:00", "end_at": "2017-08-21T11:30:00", "notes": "Test appointment 2"}
    ],
    "contacts": [
      {"contact_type": 2, "address":"email@test.com"},
      {"contact_type": 1, "address":"012345678"}
    ],
    "address": {
